                    ...
                    <div class="card-body">
                        ...
                        <form method="post" action="{{ route('store.blog') }}" enctype="multipart/form-data">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <input name="blog_image" class="form-control cls_image" type="file" id="example-text-input" >
                                </div>
                            </div>
                            <div class="row mb-3">
                                <label for="example-text-input" class="col-sm-2 col-form-label"> </label>
                                <div class="col-sm-10">
                                    <img class="rounded avatar-lg" src="{{ asset($blogs->blog_image) }}" alt="Card image cap" id="showImage">
                                </div>
                            </div>
