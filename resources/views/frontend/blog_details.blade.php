                            ...
                            <div class="row justify-content-between">
                                    ...
                                    <div class="blog__next__prev__item">
                                        ...
                                        <div class="blog__next__prev__post">
                                            <div class="blog__next__prev__thumb">
                                                <a href="{{ route('blog.details',$blogs->id )}}"><img src="{{ asset('frontend/assets/img/blog/blog_prev.jpg') }}" alt=""></a>
                                            </div>
                                            <div class="blog__next__prev__content">
                                                <h5 class="title"><a href="{{ route('blog.details',$blogs->id )}}">Digital Marketing Agency Pricing Guide.</a></h5>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-xl-5 col-md-6">
                                    <div class="blog__next__prev__item next_post text-end">
                                        ...
                                        <div class="blog__next__prev__post">
                                            <div class="blog__next__prev__thumb">
                                                <a href="{{ route('blog.details',$blogs->id )}}"><img src="{{ asset('frontend/assets/img/blog/blog_next.jpg') }}" alt=""></a>
                                            </div>
                                            <div class="blog__next__prev__content">
                                                <h5 class="title"><a href="{{ route('blog.details',$blogs->id )}}">App Prototyping
                        ...
                        <div class="widget">
                            ...
                            <ul class="sidebar__comment">
                                <li class="sidebar__comment__item">
                                    <a href="{{ route('blog.details',$blogs->id )}}">Rasalina Sponde</a>
